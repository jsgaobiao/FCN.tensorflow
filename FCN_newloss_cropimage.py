...
tf.flags.DEFINE_string("logs_dir", "logs/model_0625_crop/", "path to logs directory")
tf.flags.DEFINE_string("vis_dir", "logs/vis/test_crop/", "path to save results of visualization")
