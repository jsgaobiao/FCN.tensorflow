...
tf.flags.DEFINE_string("logs_dir", "logs/model_0615_humanloss_bs32/", "path to logs directory")
tf.flags.DEFINE_string("vis_dir", "logs/vis/test_humanloss_32/", "path to save results of visualization")
