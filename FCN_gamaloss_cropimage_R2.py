...
tf.flags.DEFINE_string("logs_dir", "logs/model_0628_gamacropR2/", "path to logs directory")
tf.flags.DEFINE_string("vis_dir", "logs/vis/test_gamacropR2/", "path to save results of visualization")
